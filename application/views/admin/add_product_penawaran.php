...
<form action="<?=base_url('admin/tambah_penawaran')?>" method="post" enctype="multipart/form-data">
    <div class="form-group">
      <input type="hidden" name="id_penawaran" value="<?= $pr->id_penawaran;?>">
      <label for="inputNama">Nama Produk</label>
      <input type="text" class="form-control" id="product_name" name="product_name" placeholder="" value="<?= $pr->nama_produk;?>">
    </div>
    <div class="form-row">
        ...
        <label for="berat">Stok</label>
             <input type="number" class="form-control" id="kuantitas" name="product_quantity" placeholder="per-gram" value="<?= $pr->stok;?>">
        </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-3">
      <label for="inputCity">Harga Beli</label>
      <input type="number" class="form-control" id="inputCity" name="harga_beli" placeholder="Rp." value="<?= $pr->harga_deal;?>">
    </div>
    <div class="form-group col-md-3">
      <label for="inputCity">Harga Konsumen</label>
      <input type="number" class="form-control" id="inputCity" name="product_price" placeholder="Rp." value="<?= $pr->harga_deal+$pr->harga_deal*0.13;?>">
    </div>
    <div class="form-group col-md-3">
      <label for="inputCity">Harga Seller</label>
      <input type="number" class="form-control" id="inputCity" name="product_price_seller" placeholder="Rp." value="<?= $pr->harga_deal+$pr->harga_deal*0.1;?>">
    </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" id="inputCity" name="product_price_eksekutif" placeholder="Rp." value="<?= $pr->harga_deal+$pr->harga_deal*0.1;?>">
    </div>
    
    <div class="form-group col-md-6">
      <label for="inputZip">Berat Konsumen Eksekutif</label>
      <input type="number" class="form-control" id="berat" name="product_weight_eksekutif" placeholder="per-gram" value="<?= 1000?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi"><?= $pr->pesan;?></textarea>
  </div>
