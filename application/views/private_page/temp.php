...
<header class="header1">
		...
		<div class="container-menu-header">
			<div class="topbar" style="background: green">
				<div class="topbar-social">
					<a href="" class="text-white"> Hubungi kami untuk bertanya</a>
					<a href="https://api.whatsapp.com/send?phone=6285882471715" class="topbar-social-item fa fa-whatsapp text-white"> &nbsp 089636424779</a>
					<a href="https://www.instagram.com//" class="topbar-social-item fa fa-instagram text-white"> Tanaman Hias</a>
			...
			<div class="wrap_header">
				...
				<div class="header-icons" id="headericon">
					...
					<div class="header-wrapicon2" ng-controller="ProductController">
						...
						<span class="p-l-50 t-center fs-12 s-text1" style="color: green;">Login</span> <img src="<?=base_url('assets')?>/images/icons/icon-header-01.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
						<?php }else { ?>
						<span class="p-l-50 t-center fs-12 s-text1" style="color: green;">SignOut</span> <img src="<?=base_url('assets')?>/images/profile/<?=$this->session->userdata('img_profile')?>" class="header-icon1 js-show-header-dropdown bo-cir" alt="ICON">
						<?php } ?>
						...
						<?php 
							...
							<div class="row p-2" id="profile">
								...
								<div class="col-lg-6 text-center align-content-center border-left">
									...
									<?php if($this->session->userdata('jenis_user') == "konsumen"){ ?>
		...
		<div class="wrap_header_mobile">
			...
			<a href="<?= base_url()?>" class="logo-mobile">
				<img src="<?=base_url('assets')?>/images/new/logo-igsb.jpg" alt="IMG-LOGO"> <span>TOKO TANAMAN</span>
			</a>
									...
									<div class="row p-2" id="profile-mobile">
										...
										<div class="col-lg-6 text-center align-content-center border-left">
											...
											<?php if($this->session->userdata('jenis_user') == "petani"){ ?>
												<button class="border bo-rad-15 p-2 m-b-5 bg9 s-text1 w-100" onclick="window.location.href='<?=base_url('petani/index')?>'">Data Produk</button>
											<?php }else{ ?>
												<button class="border bo-rad-15 p-2 m-b-5 bg9 s-text1 w-100" onclick="window.location.href='<?=base_url('users/pesanan')?>?status=belum_bayar'">Pesanan</button>
											<?php } ?>
											<button class="border bo-rad-15 p-2 m-b-5 bg10 s-text1 w-100 sign-out">sign out</button>
				...
				$.ajax({
	                ...
	                success:function(data){
						...
						transaksi.append('<div class="form-row m-t-5 m-b-5 card" id="append-bank">'+
                                ...
                                '<label for="" style="font-weight:bold">Gunakan ATM/mBanking/setor tunai untuk transfer ke rekening TOKO TANAMAN berikut ini</label>'+
                                '</div>'+
                                '<div class="card-body">'+
                                    ...
                                    '</div>'+
                                '</div>'+
								'<div class="card-footer text-justify"> <label class="font-weight-bold"> Silahkan upload bukti transfer sebelum '+data.batas+'</label> <label class="font-weight-bold"></label></div>'+
                            '</div>');
						$modal.modal("show");
	                }
	            });		
