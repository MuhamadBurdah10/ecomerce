...
<div class="card shadow mb-4">
  ...
  <?php foreach ($transaksi as $t) { ?>    
        <form action="<?=base_url('petani/update_status')?>" method="post" enctype="multipart/form-data">
        <div class="row mb-5">
            <div class="col-lg-4">
                <div class="form-row">    
            ...
            <div class="col-lg-3">
              ...
              <input type="date" class="form-control" name="tgl_estimasi" value="<?=$t->tgl_estimasi?>">
            </div>

            <div class="col-lg-3 mt-2">
              <span>Upload Resi : </span>
             <input type="file" class="form-control-file" id="exampleFormControlFile1" name="cover" data-fileuploader-default="<?= base_url('assets/images/resi/'.$t->resi);?>">
            </div>
                <div class="col-lg-1">
