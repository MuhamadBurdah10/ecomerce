...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=base_url('petani/index')?>">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?=base_url('petani/index')?>">
      ...
      <!-- Heading -->
      <div class="sidebar-heading">
        Pemesanan dan Produk
      </div>

     
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('petani/produk')?>">
          <i class="fas fa-fw fa-leaf"></i>
          <span>Produk</span></a>
      </li>
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('petani/pemesanan')?>">
